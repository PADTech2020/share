{!! Form::open(['route' => 'public.send.contact', 'method' => 'POST','id'=>'contact-form', 'class' => 'contact-us-form']) !!}
    <div class="row">
        <div class="col-md-12">
            <br>
            <div class="form-group">
                <label for="contact_name" class="control-label required">{{ __('Name') }} {{ __('(required)') }}</label>
        ...
        <div class="col-md-12">
            <div class="form-group">
                <label for="contact_email" class="control-label required">{{ __('Email') }} {{ __('(required)') }}</label>
        ...
        <div class="col-md-12">
            <div class="form-group">
                <label for="contact_phone" class="control-label">{{ __('Phone') }} {{ __('(required)') }}</label>
        ...
        <div class="col-md-12">
            <div class="form-group">
                <label for="contact_subject" class="control-label">{{ __('Subject') }} {{ __('(required)') }}</label>
    ...
    <div class="form-group">
        <div class="contact-message form-messege contact-success-message" style="display: none"></div>
